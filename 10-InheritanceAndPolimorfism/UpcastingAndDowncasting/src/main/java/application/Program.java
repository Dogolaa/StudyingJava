...
public class Program {
    public static void main(String[] args) {
        ...
        Account acc10 = new Account(1008, "Alex", 1000.0);
        acc10.withdraw(200.0);
        System.out.println(acc10.getBalance());

        Account acc11 = new SavingsAccount(1009, "Bob", 1000.0, 0.01);
        acc11.withdraw(200.0);
        System.out.println(acc11.getBalance());

        Account acc12 = new BusinessAccount(1010, "Maria", 1000.0, 500.0);
